...
public class Sacerdote extends Clases {
    ...
    public List<Habilidades> crearHabilidades() {
        ...
        habilidades.add(new DanioCuerpoACuerpo("Golpe Consagrado",5,25));
        habilidades.add(new CuraCuerpoACuerpo("Llama Sagrada",3,10));
        habilidades.add(new DanioADistancia("Rezo Sanador",1,10));
